...
const products = [
  ...
  },
  {
    ...
    name: "Saras Ghee (1L)",
    price: 650,
    image: "https://i.imgur.com/LqlBYxX.jpg",
    stock: "In Stock",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    price: 900,
    image: "https://i.imgur.com/90VWVXx.jpg",
    stock: "In Stock",
  },
  {
    id: 6,
    name: "Harpic Cleaner",
    price: 105,
    image: "https://i.imgur.com/HHW49m2.jpg",
    stock: "In Stock",
  },
  {
    id: 7,
    name: "Bartan Baar Big Pack",
    price: 60,
    image: "https://i.imgur.com/2Et4UAD.jpg",
    stock: "In Stock",
  },
  {
    id: 8,
    name: "Bikaneri Bhujia - Solo",
    price: 100,
    image: "https://i.imgur.com/jAeCKhu.jpg",
    stock: "In Stock",
  },
  {
    id: 9,
    name: "Bikaneri Bhujia - Combo",
    price: 190,
    image: "https://i.imgur.com/jAeCKhu.jpg",
    stock: "In Stock",
  },
  {
    id: 10,
    name: "Tasty Nuts - Solo",
    price: 100,
    image: "https://i.imgur.com/pS21gC3.jpg",
    stock: "In Stock",
  },
  {
    id: 11,
    name: "Tasty Nuts - Combo",
    price: 190,
    image: "https://i.imgur.com/pS21gC3.jpg",
    stock: "In Stock",
  }
...
export default function Home() {
  ...
  return (
    <div className="p-4 min-h-screen bg-gradient-to-r from-[#1a1a2e] to-[#16213e] text-white">
      <h1 className="text-3xl font-bold text-center mb-6 text-gold-500">Bilasi Ram Mohanlal Jagetiya</h1>
      {!selectedProduct ? (
